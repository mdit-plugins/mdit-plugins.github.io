...
:::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>一个没有绑定 id 的水果选项卡列表:</p>`,2),R=n("p",null,"Apple",-1),B=n("p",null,"Banana",-1),C=n("p",null,"Orange",-1),M=l(`<div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>::: tabs
...
:::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function N(V,D){const d=p("CodeTabs"),c=p("Tabs");return u(),v("div",null,[m,b(" more "),g,o(d,{id:"7",data:[{title:"TS"},{title:"JS"}],"tab-id":"language"},{tab0:a(({title:e,value:t,isActive:i})=>[_]),tab1:a(({title:e,value:t,isActive:i})=>[h]),_:1}),w,o(c,{id:"69",data:[{title:"apple",id:"apple"},{title:"banana",id:"banana"}],"tab-id":"fruit"},{tab0:a(({title:e,value:t,isActive:i})=>[f]),tab1:a(({title:e,value:t,isActive:i})=>[T]),_:1}),x,o(c,{id:"85",data:[{title:"apple"},{title:"banana"},{title:"orange"}],"tab-id":"fruit"},{tab0:a(({title:e,value:t,isActive:i})=>[y]),tab1:a(({title:e,value:t,isActive:i})=>[A]),tab2:a(({title:e,value:t,isActive:i})=>[I]),_:1}),O,o(c,{id:"106",data:[{title:"apple"},{title:"banana"},{title:"orange"}]},{tab0:a(({title:e,value:t,isActive:i})=>[R]),tab1:a(({title:e,value:t,isActive:i})=>[B]),tab2:a(({title:e,value:t,isActive:i})=>[C]),_:1}),M])}const E=r(k,[["render",N],["__file","tab.html.vue"]]);export{E as default};
