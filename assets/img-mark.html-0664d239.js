...
</code></pre></div>`,1),S=u({__name:"img-mark.html",setup(I){return(C,M)=>{const l=h("CodeTabs");return m(),k("div",null,[y,v(" more "),_,e(l,{id:"7",data:[{title:"TS"},{title:"JS"}],"tab-id":"language"},{tab0:o(({title:c,value:p,isActive:d})=>[f]),tab1:o(({title:c,value:p,isActive:d})=>[w]),_:1}),q,e(g(r)),a(" (尝试切换主题模式)"),x])}}}),N=b(S,[["__file","img-mark.html.vue"]]);export{N as default};
