...
{.table}
</code></pre></div><h3 id="list" tabindex="-1"><a class="header-anchor" href="#list" aria-hidden="true">#</a> List</h3><ul class="list-wrapper"><li class="list-item"><p>list item</p><ul class="nested"><li>nested list item</li></ul></li></ul><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token list punctuation">-</span> list item{.list-item}
...
{.break}
</code></pre></div>`,37);function x(q,y){const t=m("CodeTabs");return i(),d("div",null,[v,r(" more "),h,u(t,{id:"7",data:[{title:"TS"},{title:"JS"}],"tab-id":"language"},{tab0:s(({title:e,value:o,isActive:c})=>[b]),tab1:s(({title:e,value:o,isActive:c})=>[w]),_:1}),f])}const I=l(g,[["render",x],["__file","attrs.html.vue"]]);export{I as default};
